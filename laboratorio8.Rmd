...
ggplot(freqPais, aes(x=Var1, y=Freq)) +
  geom_bar(stat = "identity") +  coord_flip() + xlab("País de origen")+ ylab("Frecuencia")+ scale_fill_grey()
...
ggplot(freqAnio, aes(x=Var1, y=Freq)) + geom_bar(stat = "identity") + xlab("Año de importación")+ ylab("Frecuencia")
...
ggplot(freqMarca, aes(x=Var1, y=Freq)) + geom_bar(stat = "identity") +  coord_flip()+ xlab("Marca")+ ylab("Frecuencia")
